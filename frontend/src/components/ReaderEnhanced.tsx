...
import { faFile, faCalendar, faLayerGroup, faEye, faCode, faRobot, faShield } from "@fortawesome/free-solid-svg-icons";
...
export default function Reader({ noteId }: ReaderProps) {
  ...
  const [activeView, setActiveView] = useState<"original" | "chunks" | "autotag">("original");
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      {/* Sensitivity Banner */}
      {(note.sensitivity !== undefined || note.hasPii || note.hasSecrets) && (
        <SensitivityBanner
          sensitivity={note.sensitivity || 0}
          hasPii={note.hasPii}
          hasSecrets={note.hasSecrets}
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        {note.topics && note.topics.length > 0 && (
          <div className="mt-4">
            <h3 className="text-sm font-medium text-gray-700 mb-2">AI-Detected Topics:</h3>
            <div className="flex flex-wrap gap-2">
      ...
      {activeView === "autotag" ? (
        <AutotagPanel
          ...
          existingTags={note.tags ? note.tags.split(",").filter(Boolean) : []}
